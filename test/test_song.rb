...
class TestSong < JuryTest
  ...
  def test_to_s_prints_details
    song = Song.create(name: "Mercy Mercy", artist: "Booker T. & The MGs", intensity: 4, focusing: 1)
    expected = "\"Mercy Mercy\" by Booker T. & The MGs, Unclassified, intensity: 4, focusing value: true, id: #{song.id}"
  ...
  def test_edit_saves_to_the_database
    ...
    expected = ["Crusoe", "The Ex & Tom Cora", 4, true]
  ...
  def test_edit_is_reflected_in_existing_instance
    genre = Genre.find_or_create_by(name: "Unk")
    ...
    expected = ["Crusoe", "The Ex & Tom Cora", "Punk", 4, true]
  ...
  def test_save_edits_genre_id
    genre1 = Genre.find_or_create_by(name: "Punk")
  ...
  def test_search_returns_song_objects
    ...
    genre = Genre.find_or_create_by(name: "Ethiopian Jazz")
